...
<div className="card-body">
    ...
    <b title="Phone" className="mb-2" >Email:</b>  {Order.details[0].email}  <br />
                          ...
                          <h3 className="h6"> <b> BILL FROM </b></h3>
                                  ...
                                  <address>
                                    ...
                                    <br />
                                    <b title="Phone" className="mb-2">Address:</b> Unit no. DCG-0104, DLF Corporate Greens, Sector 74A, Gurugram, Haryana - 122001  
                                    <br />

                                    <b title="Phone" className="mb-2">Email:</b>  info@cayroshop.com <br />
                                    <b title="Phone" className="mb-2">Web:</b>www.www.cayroshop.com  <br />
                                  </address>
                                </div>
  ...
  <tbody>
    <tr>
      ...
      <td style={{ padding: 10, fontWeight: "bold" }}>GST</td>
    ...
    {Order.items.map((Pro) => (
                                        <tr >
                                          ...
                                          <td style={{ padding: 10 }} > {Pro.gst}% </td>

                                          <td style={{ padding: 10 }} > {Pro.quantity} </td>
                                          <td style={{ padding: 10 }}  className="text-end">₹{Pro.price}</td>
                                        </tr>
                                      ))}
  ...
  <tfoot>
          ...
          verticalAlign: "top",
          borderTop: "1px solid #dee2e6"
        }} >₹{Order.items.reduce((total, item) => total + item.quantity * item.price, 0) - Math.floor(
...
verticalAlign: "top",
borderTop: "1px solid #dee2e6"
}}  >CGST @{Order.items.reduce((total, item) => total + item.quantity * item.gst, 0) / 2}%</td>
                                          <td className="text-end" style={{
padding: ".75rem",
verticalAlign: "top",
borderTop: "1px solid #dee2e6"
...
verticalAlign: "top",
borderTop: "1px solid #dee2e6"
}}  >  SGST @{Order.items.reduce((total, item) => total + item.quantity * item.gst, 0) / 2}%</td>
                                          <td className="text-end" style={{
padding: ".75rem",
verticalAlign: "top",
borderTop: "1px solid #dee2e6"
...
verticalAlign: "top",
borderTop: "1px solid #dee2e6"
}}  > IGST @{Order.items.reduce((total, item) => total + item.quantity * item.gst, 0)}%</td>
                                          <td className="text-end"  style={{
padding: ".75rem",
verticalAlign: "top",
borderTop: "1px solid #dee2e6"
                                ...
                                <div className="card-body">
                                  <div className="row">
                                    <div className="col-lg-6 ">
                                      ...
                                      <p>
                                        Method : {Order.mode}  {'  '}    <span className={`badge ${Order.payment === 1 ? 'bg-success' : 'bg-warning'} rounded-pill`}>{Order.payment === 1 ? 'PAID' : 'UNPAID'}</span>
                                       </p>
                                    </div>
