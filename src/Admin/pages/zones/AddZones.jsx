...
const AddZones = () => {
  ...
  const submitData = async () => {
    ...
    try {
      ...
      if (admintoken) {
        await axiosInstance.post('/admin/add-zones', updatedFormData);
        console.log('zones Add successfully!');
        toast.success('zones Add successfully!');
        navigate('/all-zones');
      }
    } catch (error) {
